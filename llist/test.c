...
TEST_LIST = {
  ...
  {"NewEmptyLlist() append one item", test_newemptyllist_append_one_item},
  {"NewEmptyLlist() append two items", test_newemptyllist_append_two_items},
  {"NewEmptyLlist() append two items, second item added from the head", test_newemptyllist_append_from_head_append_two_items},
  {"NewEmptyLlist() append three items", test_newemptyllist_append_three_items},
  {"NewEmptyLlist() append three items, append then from the head", test_newemptyllist_append_from_head_append_three_items},
  {"NewLList() delete first item", test_newemptylist_append_del_item},
  {"NewLlist() append three elements, delete first item", test_newemptylist_append_three_items_del_first_item},
  {"NewLlist() append three elements, delete item in the middle", test_newemptylist_append_three_items_del_item_in_the_middle},
  {"NewLlist() append three elements, delete last item", test_newemptylist_append_three_items_del_last_item},
